            ...
            <div class="flex space-x-4 border p-4">
                ...
                <div class="w-1/2 flex flex-col gap-1 justify-start">
                    ...
                    <div class="flex items-center mt-3">
                        <span class="font-normal text-md">Registration Fee:</span> &nbsp;
                    ...
                    <div class="flex flex-col mt-5">
                        <span class="text-sm text-gray-500">Apply Promocode</span>
                        <BreezeInput v-model="promocode" type="text" class=" text-gray-700 w-1/2 bg-gray-100 rounded-none" placeholder="ex: EB2022" />
                    </div>
                </div>
            </div>
