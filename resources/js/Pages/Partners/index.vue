                ...
                <div class="grid grid-cols-4 gap-10">
                    ...
                    <div v-for="partner in partners.data" class="min-h-[200px] w-full bg-white border shadow-sm sm:rounded-lg">
                        <div class="md:shrink-0">
                            <img class="object-cover h-full w-full" src="https://via.placeholder.com/450x300?text=Sower+Institute" alt="Modern building architecture">
                        </div>
                        <div class="p-6 ">
                            ...
                            <Link :href="route('partners.view', partner.slug)" class="block mt-1 text-lg font-bold leading-tight text-gray-500 hover:text-gray-400 truncate ...">
                                {{partner.description}}
                            </Link>
                            <br>
                                ...
                                <div class="flex space-x-4">
                                    <div>
                                        ...
                                        <p class="text-red-800 truncate ...">
                                            <Link :href="partner.websiteUrl">{{ partner.websiteUrl }}</Link>
                                        </p>
                                </div>
                            </p>
                        </div>
