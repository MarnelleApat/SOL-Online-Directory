                                ...
                                <MediaDialog @selected-image="getSeletedImage">
                                    ...
                                    <template #button>
                                        <div class="flex mb-2 cursor-pointer relative">
                                            <div class="absolute bottom-6 left-14 flex text-blue-600 hover:text-blue-400 font-normal text-sm items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                                                </svg>
                                                Change Photo
                                            </div>
                                            <img :src="getPhoto.file_name ? getPhoto.file_name : props.event.thumbnail" class="rounded-full h-56 w-56" />
                                        </div>
                                    </template>
                                </MediaDialog>
                            </div>
                            ...
                            <MediaDialog @selected-image="getSeletedBanner">
                                ...
                                <template #button>
                                    <div class="flex mb-2 cursor-pointer relative justify-center">
                                        <div class="absolute bottom-3 flex text-blue-600 hover:text-blue-400 font-normal text-sm items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                                            </svg>
                                            Change Banner
                                        </div>
                                        <img :src="getBanner.file_name ? getBanner.file_name : props.event.banner" class="w-full h-48" />
                                    </div>
                                </template>
                            </MediaDialog>
