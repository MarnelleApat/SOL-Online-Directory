...
<template>
    <div class="container mx-auto">
        <div class="border-y border-gray-400">
            ...
            <div class="px-3 md:px-0 md:max-w-7xl md:mx-auto lg:py-2 lg:px-0">
                <div class="flex justify-between">
                    ...
                    <div class="hidden sm:flex sm:items-center ml-2 md:ml-4 md:hidden lg:block" style="margin-top: 2px;">
                        <BreezeDropdown align="right" width="64">
                            ...
                            <template #content>
                                <div class="flex flex-col p-3" style="opacity: 0.9;">
            ...
            <div :class="{'block left-0': showingNavigationDropdown, 'hidden -left-80': ! showingNavigationDropdown}"
                class="fixed top-0 h-screen z-50 bg-gray-700 w-[250px] p-3 flex flex-col md:flex md:flex-col space-y-1 text-white transition duration-150 ease-in-out opacity-90">
